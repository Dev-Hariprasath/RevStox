...
public class StockAnalyticsImporter {
    private static final Logger logger = LoggerConfig.getLogger("AnalyticsLogger", "analytics.log");

    private final DatabaseManager dbManager = new DatabaseManager();

    public StockAnalyticsImporter() {
    }

    public void importAnalytics(File csvFile) {
        ...
        try (
            ...
            while ((data = reader.readNext()) != null) {
                ...
                try {
                    ...
                    logger.warning("Analytics row error: " + e.getMessage());
                }
            }
